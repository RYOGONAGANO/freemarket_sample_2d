$(function() {
  ...
  <select name="category_id" id="product_child_category">
  <option value="">---</option>
  ${insertHTML}
  </select>
  ...
  <select name="product[category_id]" id="product_grandchild_category">
  <option value="">---</option>
  ${insertHTML}
  </select>
  <i class="fas fa-angle-down"></i>
  ...
  <input class="product_name" placeholder="例) シャネル" type="text" name="brand_name" id="product_brand_name">
  </div>`;
  ...
  <input class="product_name" placeholder="例) シャネル" type="text" name="brand_name" id="brand_name">
  </div>`;
    $(".exhibit__box__detail__rightbox__categorybox#category3").append(html);
  }
  ...
  $(".exhibit__box__detail__rightbox__categorybox#category1").on(
    "change",
    function() {
  ...
  $(".exhibit__box__detail__rightbox__categorybox#category2").on(
    "change",
    function() {
